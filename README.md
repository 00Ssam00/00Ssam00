...
- 🔭 Actualmente trabajando en: Coordinadora Mercantil 🚚
- 💼 Proyecto destacado personal: iuKer (sistema de gestión clínica)
- 🌱 Aprendiendo: TypeScript, Node.js, clean code y clean architecture
- 🧰 Stack backend: TypeScript, Node.js, Fastify, Jest
- 🗄️ Bases de datos: PostgreSQL
- 🎯 Objetivo actual: ascender a desarrollador backend junior
- ⚡ Fun Fact: Apasionado por el simracing buscando la mejor vuelta
